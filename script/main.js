...
$(document).ready(function(){
  ...
  function moveLeft(){
    ...
    c_btn.removeClass('act01'); //컨트롤버튼 서식 모두 제거하고
    $('.ctrl_btn span').eq(i).addClass('act01'); //해당하는 컨트롤버튼 서식에 적용.
  }
  ...
  c_btn.click(function(){//컨트롤 버튼 클릭시
    ...
    console.log(i); //0,-1, -2, -3,...
    console.log(mv); //-0,-1200, -2400, -3600,...
    // e_banner.animate({'left':mv}, 500,'easeInOutQuint');
  ...
  //3. 컨트롤 버튼에 클릭시 시간을 제거하여 멈추게하고 마우스 오버시 다시 시간을 재생하여 움직이게 한다.
  ...
  //배너(새로고침시 변경)
  let random_no = Math.floor(Math.random()*5+1);
  console.log(random_no);
  $('#r_event_banner img').attr('src','./images/banner_pc' + random_no +'.jpg');
